...
<Columns cols={3}>
  <Card title="Point of Sale (POS)" href="#pos-systems">
    Real-time sales and inventory sync with major POS platforms.
  </Card>
  <Card title="Supply Chain" href="#supply-chain">
    Automate ordering with distributors and suppliers.
  </Card>
  <Card title="Kitchen Management" href="#kitchen-systems">
    Sync KDS, recipes, and kitchen automation tools.
  </Card>
  <Card title="Enterprise Systems" href="#enterprise">
    Connect ERP, accounting, and BI platforms.
  </Card>
  <Card title="Communication" href="#communication">
    Integrate with Slack, Teams, SMS, and alerts.
  </Card>
  <Card title="IoT & Hardware" href="#iot-hardware">
    Connect sensors, scales, and smart equipment.
  </Card>
</Columns>
