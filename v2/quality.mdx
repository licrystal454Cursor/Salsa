...
<Tabs>
  <Tab title="AI Prediction">
    Predicts quality scores early and flags anomalies in real time.
  </Tab>
  <Tab title="IoT Testing">
    Automated pH, viscosity, and temperature readings with sensor alerts.
  </Tab>
</Tabs>
