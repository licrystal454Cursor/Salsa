...
<Tabs>
  <Tab title="AI Dashboard">
    AI-powered metrics, forecasting, and smart alerts for proactive decision-making.
  </Tab>
  <Tab title="IoT Analytics">
    Live sensor telemetry, equipment health monitoring, and predictive maintenance views.
  </Tab>
</Tabs>
