...
<Tabs>
  ...
  <Tab title="Manual Setup">
    1. **Create Account and Verify**
       Use email/password or SSO, then complete verification.

    2. **Profile Configuration**
       Set locations, operating hours, and kitchen capacity.

    3. **Integrations**
       Connect POS and inventory systems.

    4. **Data Import**
       Import 90+ days of history for better AI accuracy.

    5. **Enable AI**
       Turn on forecasting, quality prediction, and auto-ordering.
  </Tab>
</Tabs>
