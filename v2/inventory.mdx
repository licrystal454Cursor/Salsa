...
<Columns cols={3}>
  <Card title="AI-Powered Tracking">
    Predictive stock levels and anomaly detection.
  </Card>
  <Card title="IoT Sensor Integration">
    Real-time RFID, temperature, and weight monitoring.
  </Card>
  <Card title="Smart Waste Prevention">
    AI-driven ordering and waste reduction strategies.
  </Card>
</Columns>
